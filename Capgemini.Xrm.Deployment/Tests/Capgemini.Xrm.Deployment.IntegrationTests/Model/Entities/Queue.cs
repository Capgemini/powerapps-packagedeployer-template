...
namespace Capgemini.Xrm.Deployment.IntegrationTests.Model
{
	...
	public partial class Queue : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Capgemini.Xrm.Deployment.IntegrationTests.Model.QueueState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Capgemini.Xrm.Deployment.IntegrationTests.Model.QueueState)(System.Enum.ToObject(typeof(Capgemini.Xrm.Deployment.IntegrationTests.Model.QueueState), optionSet.Value)));
				}
				else
				{
					return null;
