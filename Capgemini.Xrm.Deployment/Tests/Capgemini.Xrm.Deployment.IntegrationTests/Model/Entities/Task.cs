...
namespace Capgemini.Xrm.Deployment.IntegrationTests.Model
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Capgemini.Xrm.Deployment.IntegrationTests.Model.TaskState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Capgemini.Xrm.Deployment.IntegrationTests.Model.TaskState)(System.Enum.ToObject(typeof(Capgemini.Xrm.Deployment.IntegrationTests.Model.TaskState), optionSet.Value)));
				}
				else
				{
					return null;
