...
namespace Capgemini.Xrm.Deployment.IntegrationTests.Model
{
	...
	public partial class Workflow : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Capgemini.Xrm.Deployment.IntegrationTests.Model.WorkflowState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Capgemini.Xrm.Deployment.IntegrationTests.Model.WorkflowState)(System.Enum.ToObject(typeof(Capgemini.Xrm.Deployment.IntegrationTests.Model.WorkflowState), optionSet.Value)));
				}
				else
				{
					return null;
