namespace Capgemini.PowerApps.PackageDeployerTemplate.Services
{
    ...
    public interface IComponentStateSettingService
    {
        ...
        void SetStatesBySolution(IEnumerable<string> solutions, IEnumerable<string> componentsToDeactivate);
        ...
        void SetStates(IEnumerable<string> componentsToActivate, IEnumerable<string> componentsToDeactivate);
    }
}